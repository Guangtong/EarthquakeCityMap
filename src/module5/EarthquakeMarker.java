...
public abstract class EarthquakeMarker extends CommonMarker
{
	...
	protected List<CommonMarker> affectedMarkers;
	...
	public EarthquakeMarker (PointFeature feature) 
	{
		...
		// marker properties include: magnitute, depth and radius(earthquake radius). 
		//What's the use of this individual radius?  -- the drawing circle radius
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		pg.fill(255,255,255);
		pg.rect(x-2, y-35, 60, 38);
		pg.fill(0,0,0);
		pg.text(this.getMagnitude(), x, y-20);
		pg.text(this.getRadius(), x, y-10);
		if(isOnLand)
			pg.text(((LandQuakeMarker)this).getCountry(), x, y);
		else
			pg.text("Oceanquake", x, y);
